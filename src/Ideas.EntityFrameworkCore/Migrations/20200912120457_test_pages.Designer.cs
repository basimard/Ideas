...
namespace Ideas.Migrations
{
    ...
    [Migration("20200912120457_test_pages")]
    partial class test_pages
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ideas.Cms.CmsContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Ideas.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Ideas.Authorization.Users.User", null)
                        .WithMany("Claims")
