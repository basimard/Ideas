...
{
    public abstract class IdeasWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static IdeasWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(IdeasWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<IdeasDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<IdeasDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<IdeasDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<IdeasDbContext, Task<T>> func)
        {
            T result;
